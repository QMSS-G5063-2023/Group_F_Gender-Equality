...
### In movies with better female representation (passed the Bechdel test) have more common words in the plot like woman, school, life, girl, family (which are family-oriented and domestic).
...
### While movies with less female representation (failed the Bechdel test) have plots with common words like life, world, story, team etc. which implies more adventure-driven movies
```{r, echo = FALSE, message = FALSE}
